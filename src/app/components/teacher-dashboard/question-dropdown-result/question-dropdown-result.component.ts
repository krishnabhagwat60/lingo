...
@Component({
  selector: 'app-question-dropdown-result',
  templateUrl: './question-dropdown-result.component.html',
  styleUrls: ['./question-dropdown-result.component.css']
})
export class QuestionDropdownResultComponent implements OnInit {
  sidebarData: any;
  id: string;
  ...
  solutionPage(){
    this.router.navigate(['/teacherDashboard/questionDropSolution'], { queryParams: {titleid:this.titleid } });
