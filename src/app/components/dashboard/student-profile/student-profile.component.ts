...
export class StudentProfileComponent implements OnInit {
  ...
  updateData() {
    ...
    this.service.post('get_profile_by_id', data, 1).subscribe((res) => {
      ...
      if (
        this.updateNewData.main_language_id != null &&
        this.updateNewData.main_language_id != undefined &&
        this.updateNewData.main_language_id != ''
      ) {
      ...
      if (
        this.updateNewData.known_language_id != null &&
        this.updateNewData.known_language_id != undefined &&
        this.updateNewData.known_language_id != ''
      ) {
        if (this.updateNewData.known_language_id.length > 0) {
          ...
          for (
            var i = 0;
            i < this.updateNewData.known_language_id.length;
            i++
          ) {
  ...
  getState() {
    ...
    this.allCityList = null;
    this.service
      .getData('states/' + this.profileForm.value.countrys, this.authToken)
      .subscribe((result) => {
